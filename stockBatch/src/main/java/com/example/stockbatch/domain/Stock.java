...
public class Stock {
    ...
    @Builder
    private Stock(Long id, String itemCode, String stockName, String category, Long accumulatedTradingVolume, Long accumulatedTradingValue, Double fluctuationsRatio) {
        this.id = id;
